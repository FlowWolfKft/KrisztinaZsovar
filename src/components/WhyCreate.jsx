...
function WhyCreate() {
  return (
    <div className="content-box">
      ...
      <p>
        És megszületett bennem a kérdés: Hogyan találhatok vissza önmagamhoz?
      </p>
      ...
      <ul>
        ...
        <li>✓ regeneráció</li>
        <li>✓ jóga</li>
        <li>✓ hormonbarát szemlélet</li>
        <li>✓ energetikai munka</li>
        <li>✓ önszeretet</li>
      </ul>
      <h3>Így született meg a Női Esszencia.</h3>
    </div>
  );
}
